 ...
 * 构建查询条件
 * <p>
 * 用户在做条件查询时不用手写SQL，实现业务代码与SQL解耦
 *
 * @author lmmarise.j@gmail.com
 * @since 2021/8/25 8:22 下午
 */
public final class QueryRule implements Serializable {
    ...
    public QueryRule andLessTan(String propertyName, Object value) {
        this.ruleList.add(new Rule(LT, propertyName, new Object[]{value}).setAndOr(AND));
        return this;
    }

    public QueryRule orLessTan(String propertyName, Object value) {
